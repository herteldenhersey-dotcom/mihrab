...
abstract class FeedbackRepository {
  ...
  /// with its `deliveryStatus` updated to reflect the attempt (V1 can report at
  /// most `handoffInitiated` — see [FeedbackItem.deliveryStatus]).
  ...
  /// Re-attempts delivery of any queued feedback (items not yet handed off).
